...
function generateTr(compte) {
  return `<tr onmouseover="$affichebtn(this)" onmouseout="masquebtn(this)">
        <td onmouseover="afficheBtnTd(this)" onmouseout="masqueBtnTd(this)" >${
          compte.prenom + " " + compte.nom
        }
            <div>
               <a href="${WEBURL}/?ressource=html&controller=compte&action=cClient&key=${
    compte.idu
  }" class="btn btn-primary" hidden >Compte</a>
               <a href="${WEBURL}/ressource=html&controller=transaction&action=tClient&key=${
    compte.idu
  }"  class="btn btn-primary" hidden >transaction</a>
            </div>
        </td>
